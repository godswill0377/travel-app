...
import { NavigationActions, DrawerActions, StackNavigator } from 'react-navigation';
...
export default class Home extends Component {
  ...
  places() {
    ...
    const navigateAction = NavigationActions.navigate({
      routeName: 'PlacesCategoriesScreen'
    });
    this.props.navigation.dispatch(navigateAction);
  ...
  offers() {
    ...
    const navigateAction = NavigationActions.navigate({
      routeName: 'OffersCategoriesScreen'
    });
    this.props.navigation.dispatch(navigateAction);
...
<Grid >
    <Col style={{alignItems: 'flex-start', alignContent: 'flex-start', justifyContent: 'flex-start'}}>
      <TouchableOpacity onPress={() => this.props.navigation.navigate('DrawerOpen')} activeOpacity={1}>
